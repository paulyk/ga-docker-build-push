...
public class ComponentSerialService {
    ...
    public async Task<MutationResult<ComponentSerialDTO>> SaveComponentSerial(ComponentSerialInput input) {
        ...
        componentSerial.KitComponentId = input.KitComponentId;
        componentSerial.Serial1 = formatSerialResult.Serials.Serial1;
        componentSerial.Serial2 = formatSerialResult.Serials.Serial2;
